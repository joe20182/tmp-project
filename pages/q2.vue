<template>
  <div>
    ...
    <code-section
      code="Combine q1 function, we need to design a timeout function, if the request does not complete within 5 seconds, return 'Timeout'"
    />
...
// I saw the function is already implemented in the source code, so I'll just skip Q2
