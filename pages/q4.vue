<template>
  <div>
    ...
    <code-section
      code="Each time getData function is executed, it will return a random number. Please design a cache function, which can cache the result of the function in 5 seconds"
    />
